    ...
    <div className='grid gap-8 lg:grid-cols-2'>
        {
            ...
            className='max-w-lg flex shadow-lg shadow-cyan-500 rounded-2xl overflow-hidden duration-300 ease-in-out hover:scale-105 hover:shadow-rose-500'>
                ...
                <div className='w-1/3 flex flex-col items-center justify-evenly p-1'>
                    <h2>{title}</h2>
                    <a className='text-2xl cursor-pointer duration-150 hover:scale-125 hover:text-green-500' href={github}
                    target='_blank'
                    rel='noopener noreferrer'><FaGithub /></a>
                    <a className='text-2xl cursor-pointer duration-150 hover:scale-125 hover:text-green-500' href={Deployment}
                    target='_blank'
